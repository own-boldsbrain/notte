...
```python
execute(action: notte_core.actions.BaseAction | dict[str, typing.Any] | None = None, raise_on_failure: bool | None = None, kwargs: *<class 'notte_sdk.types.ExecutionRequestDict'>) -> <class 'notte_core.browser.observation.ExecutionResult'>
```
...
```python
replay() -> <class 'notte_core.utils.webp_replay.MP4Replay'>
```
